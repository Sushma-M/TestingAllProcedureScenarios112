...
public class UserLoginServiceImpl implements UserLoginService {
    ...
    public UserLogin partialUpdate(Integer userloginId, Map<String, Object>userLoginPatch) {
        ...
        try {
            ObjectReader userLoginReader = this.objectMapper.readerForUpdating(userLogin);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service School_DB for table UserLogin to {} format", options.getExportType());
