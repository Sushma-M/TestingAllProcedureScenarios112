...
public class AcademicSubjectsServiceImpl implements AcademicSubjectsService {
    ...
    public AcademicSubjects create(AcademicSubjects academicSubjects) {
        ...
        List<AcademicTestSubjects> academicTestSubjectses = academicSubjects.getAcademicTestSubjectses();
        if(academicTestSubjectses != null && Hibernate.isInitialized(academicTestSubjectses)) {
            academicTestSubjectses.forEach(_academicTestSubjects -> _academicTestSubjects.setAcademicSubjects(academicSubjects));
        }
    ...
    public AcademicSubjects partialUpdate(AcademicSubjectsId academicsubjectsId, Map<String, Object>academicSubjectsPatch) {
        ...
        try {
            ObjectReader academicSubjectsReader = this.objectMapper.readerForUpdating(academicSubjects);
