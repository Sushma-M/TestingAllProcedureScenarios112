...
public class SubjectDetailsServiceImpl implements SubjectDetailsService {
    ...
    @Transactional(value = "School_DBTransactionManager")
    @Override
    public SubjectDetails partialUpdate(Integer subjectdetailsId, Map<String, Object>subjectDetailsPatch) {
        LOGGER.debug("Partially Updating the SubjectDetails with id: {}", subjectdetailsId);

        SubjectDetails subjectDetails = getById(subjectdetailsId);

        try {
            ObjectReader subjectDetailsReader = this.objectMapper.readerForUpdating(subjectDetails);
            subjectDetails = subjectDetailsReader.readValue(this.objectMapper.writeValueAsString(subjectDetailsPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", subjectDetailsPatch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        subjectDetails = update(subjectDetails);
    ...
    public SubjectDetails delete(Integer subjectdetailsId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), SubjectDetails.class.getSimpleName(), subjectdetailsId);
        }
