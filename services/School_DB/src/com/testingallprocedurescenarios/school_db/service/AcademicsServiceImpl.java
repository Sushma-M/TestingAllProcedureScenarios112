...
public class AcademicsServiceImpl implements AcademicsService {
    ...
    public Academics create(Academics academics) {
        ...
        List<AcademicSubjects> academicSubjectses = academics.getAcademicSubjectses();
        List<StudentAcademics> studentAcademicses = academics.getStudentAcademicses();
        if(academicSubjectses != null && Hibernate.isInitialized(academicSubjectses)) {
            academicSubjectses.forEach(_academicSubjects -> _academicSubjects.setAcademics(academics));
        }
        if(studentAcademicses != null && Hibernate.isInitialized(studentAcademicses)) {
            studentAcademicses.forEach(_studentAcademics -> _studentAcademics.setAcademics(academics));
        }
    ...
    public Academics partialUpdate(AcademicsId academicsId, Map<String, Object>academicsPatch) {
        ...
        try {
            ObjectReader academicsReader = this.objectMapper.readerForUpdating(academics);
