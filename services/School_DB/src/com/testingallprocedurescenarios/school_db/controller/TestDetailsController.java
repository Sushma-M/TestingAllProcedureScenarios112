...
import com.testingallprocedurescenarios.school_db.service.TestDetailsService;
...
public class TestDetailsController {
    ...
    @ApiOperation(value = "Partially updates the TestDetails instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TestDetails patchTestDetails(@PathVariable("id") Integer id, @RequestBody @MapTo(TestDetails.class) Map<String, Object> testDetailsPatch) {
        LOGGER.debug("Partially updating TestDetails with id: {}" , id);

        TestDetails testDetails = testDetailsService.partialUpdate(id, testDetailsPatch);
