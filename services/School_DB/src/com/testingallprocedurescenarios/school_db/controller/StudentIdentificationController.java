...
import com.testingallprocedurescenarios.school_db.service.StudentIdentificationService;
...
public class StudentIdentificationController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentIdentification patchStudentIdentification(@PathVariable("id") Integer id, @RequestBody @MapTo(StudentIdentification.class) Map<String, Object> studentIdentificationPatch) {
        LOGGER.debug("Partially updating StudentIdentification with id: {}" , id);

        StudentIdentification studentIdentification = studentIdentificationService.partialUpdate(id, studentIdentificationPatch);
