...
public class ViewResultsController {
	...
	@ApiOperation(value = "Partially updates the  ViewResults instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ViewResults patchViewResults(@RequestParam("totalMarks") BigInteger totalMarks, @RequestParam("academicYear") String academicYear, @RequestParam("standardId") Integer standardId, @RequestParam("studentId") Integer studentId, @RequestParam("studentName") String studentName, @RequestParam("testId") Integer testId, @RequestBody @MapTo(ViewResults.class) Map<String, Object> viewResultsPatch) {
        ...
        viewresultsId.setStudentName(studentName);
        viewresultsId.setTestId(testId);
        LOGGER.debug("Partially updating ViewResults with id: {}" , viewresultsId);

        ViewResults viewResults = viewResultsService.partialUpdate(viewresultsId, viewResultsPatch);
        LOGGER.debug("ViewResults details after partial update: {}" , viewResults);
