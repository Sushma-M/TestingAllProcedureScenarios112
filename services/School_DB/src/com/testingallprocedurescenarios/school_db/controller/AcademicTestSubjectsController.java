...
import com.testingallprocedurescenarios.school_db.AcademicTestSubjectsId;
import com.testingallprocedurescenarios.school_db.TestConducted;
import com.testingallprocedurescenarios.school_db.service.AcademicTestSubjectsService;
...
public class AcademicTestSubjectsController {
	...
	@ApiOperation(value = "Partially updates the  AcademicTestSubjects instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicTestSubjects patchAcademicTestSubjects(@RequestParam("academicYear") String academicYear, @RequestParam("subjectId") Integer subjectId, @RequestParam("testId") Integer testId, @RequestParam("standardId") Integer standardId, @RequestBody @MapTo(AcademicTestSubjects.class) Map<String, Object> academicTestSubjectsPatch) {
        ...
        academictestsubjectsId.setTestId(testId);
        academictestsubjectsId.setStandardId(standardId);
        LOGGER.debug("Partially updating AcademicTestSubjects with id: {}" , academictestsubjectsId);

        AcademicTestSubjects academicTestSubjects = academicTestSubjectsService.partialUpdate(academictestsubjectsId, academicTestSubjectsPatch);
        LOGGER.debug("AcademicTestSubjects details after partial update: {}" , academicTestSubjects);
