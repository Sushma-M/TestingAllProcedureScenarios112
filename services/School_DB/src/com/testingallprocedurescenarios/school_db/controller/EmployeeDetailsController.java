...
import com.testingallprocedurescenarios.school_db.EmployeeDetails;
import com.testingallprocedurescenarios.school_db.service.EmployeeDetailsService;
...
public class EmployeeDetailsController {
    ...
    @ApiOperation(value = "Partially updates the EmployeeDetails instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDetails patchEmployeeDetails(@PathVariable("id") Integer id, @RequestBody @MapTo(EmployeeDetails.class) Map<String, Object> employeeDetailsPatch) {
        LOGGER.debug("Partially updating EmployeeDetails with id: {}" , id);

        EmployeeDetails employeeDetails = employeeDetailsService.partialUpdate(id, employeeDetailsPatch);
        LOGGER.debug("EmployeeDetails details after partial update: {}" , employeeDetails);
