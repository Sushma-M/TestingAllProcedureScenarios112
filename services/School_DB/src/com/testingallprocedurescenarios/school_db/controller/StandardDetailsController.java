...
import com.testingallprocedurescenarios.school_db.service.StandardDetailsService;
...
public class StandardDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StandardDetails patchStandardDetails(@PathVariable("id") Integer id, @RequestBody @MapTo(StandardDetails.class) Map<String, Object> standardDetailsPatch) {
        LOGGER.debug("Partially updating StandardDetails with id: {}" , id);

        StandardDetails standardDetails = standardDetailsService.partialUpdate(id, standardDetailsPatch);
