...
import com.testingallprocedurescenarios.school_db.service.StudentDetailsService;
...
public class StudentDetailsController {
    ...
    @ApiOperation(value = "Partially updates the StudentDetails instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentDetails patchStudentDetails(@PathVariable("id") Integer id, @RequestBody @MapTo(StudentDetails.class) Map<String, Object> studentDetailsPatch) {
        LOGGER.debug("Partially updating StudentDetails with id: {}" , id);

        StudentDetails studentDetails = studentDetailsService.partialUpdate(id, studentDetailsPatch);
