...
import com.testingallprocedurescenarios.school_db.service.SubjectDetailsService;
...
public class SubjectDetailsController {
    ...
    @ApiOperation(value = "Partially updates the SubjectDetails instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SubjectDetails patchSubjectDetails(@PathVariable("id") Integer id, @RequestBody @MapTo(SubjectDetails.class) Map<String, Object> subjectDetailsPatch) {
        LOGGER.debug("Partially updating SubjectDetails with id: {}" , id);

        SubjectDetails subjectDetails = subjectDetailsService.partialUpdate(id, subjectDetailsPatch);
        LOGGER.debug("SubjectDetails details after partial update: {}" , subjectDetails);
