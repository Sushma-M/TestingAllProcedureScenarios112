...
public class Table9ServiceImpl implements Table9Service {
    ...
    @Transactional(value = "dbscenariosTransactionManager")
    @Override
    public Table9 partialUpdate(String table9Id, Map<String, Object>table9Patch) {
        LOGGER.debug("Partially Updating the Table9 with id: {}", table9Id);

        Table9 table9 = getById(table9Id);

        try {
            ObjectReader table9Reader = this.objectMapper.readerForUpdating(table9);
            table9 = table9Reader.readValue(this.objectMapper.writeValueAsString(table9Patch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", table9Patch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        table9 = update(table9);
    ...
    public Table9 delete(String table9Id) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Table9.class.getSimpleName(), table9Id);
        }
