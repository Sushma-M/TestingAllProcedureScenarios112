...
public class UpServiceImpl implements UpService {
    ...
    @Transactional(value = "dbscenariosTransactionManager")
    @Override
    public Up partialUpdate(Integer upId, Map<String, Object>upPatch) {
        LOGGER.debug("Partially Updating the Up with id: {}", upId);

        Up up = getById(upId);

        try {
            ObjectReader upReader = this.objectMapper.readerForUpdating(up);
            up = upReader.readValue(this.objectMapper.writeValueAsString(upPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", upPatch, ex);
    ...
    public Up delete(Integer upId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Up.class.getSimpleName(), upId);
        }
