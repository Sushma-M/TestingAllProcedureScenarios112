...
public interface Table9Service {
     ...
     */
    Table9 create(@Valid Table9 table9);
     ...
     */
    Table9 getById(String table9Id);
     ...
     * @return Table9 associated with the given table9Id.
     */
    Table9 findById(String table9Id);

	/**
     * Find and return the list of Table9s by given id's.
     *
     ...
     *
     * @param table9Ids The id's of the Table9 to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Table9s associated with the given table9Ids.
     */
    List<Table9> findByMultipleIds(List<String> table9Ids, boolean orderedReturn);
     ...
     */
    Table9 delete(String table9Id);

    /**
     * Deletes an existing Table9 with the given object.
     *
     * @param table9 The instance of the Table9 to be deleted; value cannot be null.
     */
    void delete(Table9 table9);
