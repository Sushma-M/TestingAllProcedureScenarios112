...
import com.testingallprocedurescenarios.dbscenarios.AllTypes;
...
public class AllTypesServiceImpl implements AllTypesService {
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios for table AllTypes to {} format", options.getExportType());
