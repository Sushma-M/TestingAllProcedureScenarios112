...
/**
 * Specifies methods used to obtain and modify DbtYpes related information
 * which is stored in the database.
 */
@Repository("dbscenarios.DbtYpesDao")
public class DbtYpesDao extends WMGenericDaoImpl<DbtYpes, Integer> {
