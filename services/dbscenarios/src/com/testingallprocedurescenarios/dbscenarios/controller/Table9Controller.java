...
public class Table9Controller {
    ...
    @ApiOperation(value = "Partially updates the Table9 instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table9 patchTable9(@PathVariable("id") String id, @RequestBody @MapTo(Table9.class) Map<String, Object> table9Patch) {
        LOGGER.debug("Partially updating Table9 with id: {}" , id);

        Table9 table9 = table9Service.partialUpdate(id, table9Patch);
        LOGGER.debug("Table9 details after partial update: {}" , table9);
