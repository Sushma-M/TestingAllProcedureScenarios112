...
import com.testingallprocedurescenarios.dbscenarios.service.Table6Service;
...
public class Table6Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table6 getTable6(@PathVariable("id") Long id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table6 editTable6(@PathVariable("id") Long id, @RequestBody Table6 table6) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table6 patchTable6(@PathVariable("id") Long id, @RequestBody @MapTo(Table6.class) Map<String, Object> table6Patch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable6(@PathVariable("id") Long id) {
