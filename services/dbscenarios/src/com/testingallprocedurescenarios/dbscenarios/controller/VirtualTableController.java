...
import com.testingallprocedurescenarios.dbscenarios.service.VirtualTableService;
...
public class VirtualTableController {
    ...
    @ApiOperation(value = "Returns the VirtualTable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VirtualTable getVirtualTable(@PathVariable("id") String id) {
        LOGGER.debug("Getting VirtualTable with id: {}" , id);

        VirtualTable foundVirtualTable = virtualTableService.getById(id);
        LOGGER.debug("VirtualTable details with id: {}" , foundVirtualTable);

        return foundVirtualTable;
    }

    @ApiOperation(value = "Updates the VirtualTable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VirtualTable editVirtualTable(@PathVariable("id") String id, @RequestBody VirtualTable virtualTable) {
        LOGGER.debug("Editing VirtualTable with id: {}" , virtualTable.getCharCol());

        virtualTable.setCharCol(id);
        virtualTable = virtualTableService.update(virtualTable);
        LOGGER.debug("VirtualTable details with id: {}" , virtualTable);

        return virtualTable;
    }
    
    @ApiOperation(value = "Partially updates the VirtualTable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VirtualTable patchVirtualTable(@PathVariable("id") String id, @RequestBody @MapTo(VirtualTable.class) Map<String, Object> virtualTablePatch) {
        LOGGER.debug("Partially updating VirtualTable with id: {}" , id);

        VirtualTable virtualTable = virtualTableService.partialUpdate(id, virtualTablePatch);
        LOGGER.debug("VirtualTable details after partial update: {}" , virtualTable);

        return virtualTable;
    }

    @ApiOperation(value = "Deletes the VirtualTable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVirtualTable(@PathVariable("id") String id) {
        LOGGER.debug("Deleting VirtualTable with id: {}" , id);

        VirtualTable deletedVirtualTable = virtualTableService.delete(id);

        return deletedVirtualTable != null;
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VirtualTable getByStringColAndDateCol(@RequestParam("stringCol") Character stringCol, @RequestParam("dateCol") Date dateCol) {
