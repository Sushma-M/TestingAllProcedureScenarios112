...
public class UpController {
    ...
    @ApiOperation(value = "Partially updates the Up instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Up patchUp(@PathVariable("id") Integer id, @RequestBody @MapTo(Up.class) Map<String, Object> upPatch) {
        LOGGER.debug("Partially updating Up with id: {}" , id);

        Up up = upService.partialUpdate(id, upPatch);
        LOGGER.debug("Up details after partial update: {}" , up);
