...
public class ZeroAsPkController {
    ...
    @ApiOperation(value = "Partially updates the ZeroAsPk instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ZeroAsPk patchZeroAsPk(@PathVariable("id") Integer id, @RequestBody @MapTo(ZeroAsPk.class) Map<String, Object> zeroAsPkPatch) {
        LOGGER.debug("Partially updating ZeroAsPk with id: {}" , id);

        ZeroAsPk zeroAsPk = zeroAsPkService.partialUpdate(id, zeroAsPkPatch);
        LOGGER.debug("ZeroAsPk details after partial update: {}" , zeroAsPk);
