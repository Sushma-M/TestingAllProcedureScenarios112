...
import com.testingallprocedurescenarios.wmstudio.service.CountriesService;
...
public class CountriesController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Countries patchCountries(@PathVariable("id") String id, @RequestBody @MapTo(Countries.class) Map<String, Object> countriesPatch) {
