...
import com.testingallprocedurescenarios.wmstudio.service.LocationsService;
...
public class LocationsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Locations patchLocations(@PathVariable("id") Short id, @RequestBody @MapTo(Locations.class) Map<String, Object> locationsPatch) {
        LOGGER.debug("Partially updating Locations with id: {}" , id);

        Locations locations = locationsService.partialUpdate(id, locationsPatch);
