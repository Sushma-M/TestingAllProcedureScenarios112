...
import com.testingallprocedurescenarios.wmstudio.service.JobsService;
...
public class JobsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Jobs patchJobs(@PathVariable("id") String id, @RequestBody @MapTo(Jobs.class) Map<String, Object> jobsPatch) {
        LOGGER.debug("Partially updating Jobs with id: {}" , id);

        Jobs jobs = jobsService.partialUpdate(id, jobsPatch);
