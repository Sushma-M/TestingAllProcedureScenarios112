...
import com.testingallprocedurescenarios.wmstudio.service.EmployeesService;
...
public class EmployeesController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employees patchEmployees(@PathVariable("id") Integer id, @RequestBody @MapTo(Employees.class) Map<String, Object> employeesPatch) {
        LOGGER.debug("Partially updating Employees with id: {}" , id);

        Employees employees = employeesService.partialUpdate(id, employeesPatch);
