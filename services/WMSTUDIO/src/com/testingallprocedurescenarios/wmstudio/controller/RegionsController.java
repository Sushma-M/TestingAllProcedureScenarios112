...
import com.testingallprocedurescenarios.wmstudio.service.RegionsService;
...
public class RegionsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Regions patchRegions(@PathVariable("id") BigInteger id, @RequestBody @MapTo(Regions.class) Map<String, Object> regionsPatch) {
        LOGGER.debug("Partially updating Regions with id: {}" , id);

        Regions regions = regionsService.partialUpdate(id, regionsPatch);
