...
public class EmployeesServiceImpl implements EmployeesService {
    ...
    public Employees create(Employees employees) {
        ...
        List<Departments> departmentsesForManagerId = employees.getDepartmentsesForManagerId();
        List<Employees> employeesesForManagerId = employees.getEmployeesesForManagerId();
        List<JobHistory> jobHistories = employees.getJobHistories();
        if(departmentsesForManagerId != null && Hibernate.isInitialized(departmentsesForManagerId)) {
            departmentsesForManagerId.forEach(_departments -> _departments.setEmployeesByManagerId(employees));
        }
        if(employeesesForManagerId != null && Hibernate.isInitialized(employeesesForManagerId)) {
            employeesesForManagerId.forEach(_employees -> _employees.setEmployeesByManagerId(employees));
        }
        if(jobHistories != null && Hibernate.isInitialized(jobHistories)) {
            jobHistories.forEach(_jobHistory -> _jobHistory.setEmployees(employees));
        }
    ...
    public Employees partialUpdate(Integer employeesId, Map<String, Object>employeesPatch) {
        ...
        try {
            ObjectReader employeesReader = this.objectMapper.readerForUpdating(employees);
