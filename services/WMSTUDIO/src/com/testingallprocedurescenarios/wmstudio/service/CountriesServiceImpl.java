...
public class CountriesServiceImpl implements CountriesService {
    ...
    public Countries create(Countries countries) {
        ...
        List<Locations> locationses = countries.getLocationses();
        if(locationses != null && Hibernate.isInitialized(locationses)) {
            locationses.forEach(_locations -> _locations.setCountries(countries));
        }
    ...
    public Countries partialUpdate(String countriesId, Map<String, Object>countriesPatch) {
        ...
        try {
            ObjectReader countriesReader = this.objectMapper.readerForUpdating(countries);
