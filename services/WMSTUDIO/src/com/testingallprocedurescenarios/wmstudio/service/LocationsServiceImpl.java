...
public class LocationsServiceImpl implements LocationsService {
    ...
    public Locations create(Locations locations) {
        ...
        List<Departments> departmentses = locations.getDepartmentses();
        if(departmentses != null && Hibernate.isInitialized(departmentses)) {
            departmentses.forEach(_departments -> _departments.setLocations(locations));
        }
    ...
    public Locations partialUpdate(Short locationsId, Map<String, Object>locationsPatch) {
        ...
        try {
            ObjectReader locationsReader = this.objectMapper.readerForUpdating(locations);
