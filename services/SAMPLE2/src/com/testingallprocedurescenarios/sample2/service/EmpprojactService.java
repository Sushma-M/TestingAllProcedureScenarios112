...
public interface EmpprojactService {
     ...
     */
    Empprojact create(@Valid Empprojact empprojact);
     ...
     */
    Empprojact getById(EmpprojactId empprojactId);
	...
	/**
     * Find and return the list of Empprojacts by given id's.
     *
     ...
     *
     * @param empprojactIds The id's of the Empprojact to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Empprojacts associated with the given empprojactIds.
     */
    List<Empprojact> findByMultipleIds(List<EmpprojactId> empprojactIds, boolean orderedReturn);
     ...
     */
    Empprojact delete(EmpprojactId empprojactId);

    /**
     * Deletes an existing Empprojact with the given object.
     *
     * @param empprojact The instance of the Empprojact to be deleted; value cannot be null.
     */
    void delete(Empprojact empprojact);
