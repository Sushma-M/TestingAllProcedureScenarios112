...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Transactional(value = "SAMPLE2TransactionManager")
    @Override
    public Customer partialUpdate(BigInteger customerId, Map<String, Object>customerPatch) {
        LOGGER.debug("Partially Updating the Customer with id: {}", customerId);

        Customer customer = getById(customerId);

        try {
            ObjectReader customerReader = this.objectMapper.readerForUpdating(customer);
