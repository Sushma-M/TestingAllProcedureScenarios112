...
public interface VhdeptService {
     ...
     */
    Vhdept create(@Valid Vhdept vhdept);
     ...
     */
    Vhdept getById(VhdeptId vhdeptId);
	...
	/**
     * Find and return the list of Vhdepts by given id's.
     *
     ...
     *
     * @param vhdeptIds The id's of the Vhdept to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Vhdepts associated with the given vhdeptIds.
     */
    List<Vhdept> findByMultipleIds(List<VhdeptId> vhdeptIds, boolean orderedReturn);
     ...
     */
    Vhdept delete(VhdeptId vhdeptId);

    /**
     * Deletes an existing Vhdept with the given object.
     *
     * @param vhdept The instance of the Vhdept to be deleted; value cannot be null.
     */
    void delete(Vhdept vhdept);
