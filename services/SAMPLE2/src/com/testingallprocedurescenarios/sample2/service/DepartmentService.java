...
public interface DepartmentService {
     ...
     */
    List<Department> findByMultipleIds(List<String> departmentIds, boolean orderedReturn);
     ...
     * @throws EntityNotFoundException if no Department is found with given input.
     */
    Department partialUpdate(String departmentId, Map<String, Object> departmentPatch);
     ...
     */
    Department delete(String departmentId);
