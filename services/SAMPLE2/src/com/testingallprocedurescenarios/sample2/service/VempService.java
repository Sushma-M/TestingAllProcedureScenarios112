...
public interface VempService {
	...
	/**
     * Find and return the list of Vemps by given id's.
     *
     ...
     *
     * @param vempIds The id's of the Vemp to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Vemps associated with the given vempIds.
     */
    List<Vemp> findByMultipleIds(List<VempId> vempIds, boolean orderedReturn);
     ...
     */
    Vemp delete(VempId vempId);

    /**
     * Deletes an existing Vemp with the given object.
     *
     * @param vemp The instance of the Vemp to be deleted; value cannot be null.
     */
    void delete(Vemp vemp);
