...
public class ProductsupplierServiceImpl implements ProductsupplierService {
    ...
    @Transactional(value = "SAMPLE2TransactionManager")
    @Override
    public Productsupplier partialUpdate(ProductsupplierId productsupplierId, Map<String, Object>productsupplierPatch) {
        LOGGER.debug("Partially Updating the Productsupplier with id: {}", productsupplierId);

        Productsupplier productsupplier = getById(productsupplierId);

        try {
            ObjectReader productsupplierReader = this.objectMapper.readerForUpdating(productsupplier);
            productsupplier = productsupplierReader.readValue(this.objectMapper.writeValueAsString(productsupplierPatch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", productsupplierPatch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        productsupplier = update(productsupplier);
    ...
    public Productsupplier delete(ProductsupplierId productsupplierId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Productsupplier.class.getSimpleName(), productsupplierId);
        }
