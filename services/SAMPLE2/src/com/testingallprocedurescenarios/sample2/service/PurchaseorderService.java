...
public interface PurchaseorderService {
     ...
     */
    Purchaseorder create(@Valid Purchaseorder purchaseorder);
     ...
     */
    Purchaseorder getById(BigInteger purchaseorderId);
	...
	/**
     * Find and return the list of Purchaseorders by given id's.
     *
     ...
     *
     * @param purchaseorderIds The id's of the Purchaseorder to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Purchaseorders associated with the given purchaseorderIds.
     */
    List<Purchaseorder> findByMultipleIds(List<BigInteger> purchaseorderIds, boolean orderedReturn);
     ...
     */
    Purchaseorder delete(BigInteger purchaseorderId);

    /**
     * Deletes an existing Purchaseorder with the given object.
     *
     * @param purchaseorder The instance of the Purchaseorder to be deleted; value cannot be null.
     */
