...
public interface Vdepmg1Service {
     ...
     */
    Vdepmg1 create(@Valid Vdepmg1 vdepmg1);
     ...
     */
    Vdepmg1 getById(Vdepmg1Id vdepmg1Id);
	...
	/**
     * Find and return the list of Vdepmg1s by given id's.
     *
     ...
     *
     * @param vdepmg1Ids The id's of the Vdepmg1 to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Vdepmg1s associated with the given vdepmg1Ids.
     */
    List<Vdepmg1> findByMultipleIds(List<Vdepmg1Id> vdepmg1Ids, boolean orderedReturn);
     ...
     */
    Vdepmg1 delete(Vdepmg1Id vdepmg1Id);

    /**
     * Deletes an existing Vdepmg1 with the given object.
     *
     * @param vdepmg1 The instance of the Vdepmg1 to be deleted; value cannot be null.
     */
    void delete(Vdepmg1 vdepmg1);
