...
public class Vstafac1ServiceImpl implements Vstafac1Service {
    ...
    @Transactional(value = "SAMPLE2TransactionManager")
    @Override
    public Vstafac1 partialUpdate(Vstafac1Id vstafac1Id, Map<String, Object>vstafac1Patch) {
        LOGGER.debug("Partially Updating the Vstafac1 with id: {}", vstafac1Id);

        Vstafac1 vstafac1 = getById(vstafac1Id);

        try {
            ObjectReader vstafac1Reader = this.objectMapper.readerForUpdating(vstafac1);
            vstafac1 = vstafac1Reader.readValue(this.objectMapper.writeValueAsString(vstafac1Patch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", vstafac1Patch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        vstafac1 = update(vstafac1);
    ...
    public Vstafac1 delete(Vstafac1Id vstafac1Id) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Vstafac1.class.getSimpleName(), vstafac1Id);
        }
