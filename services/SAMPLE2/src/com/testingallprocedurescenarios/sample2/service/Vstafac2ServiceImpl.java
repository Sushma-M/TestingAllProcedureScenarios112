...
public class Vstafac2ServiceImpl implements Vstafac2Service {
    ...
    @Transactional(value = "SAMPLE2TransactionManager")
    @Override
    public Vstafac2 partialUpdate(Vstafac2Id vstafac2Id, Map<String, Object>vstafac2Patch) {
        LOGGER.debug("Partially Updating the Vstafac2 with id: {}", vstafac2Id);

        Vstafac2 vstafac2 = getById(vstafac2Id);

        try {
            ObjectReader vstafac2Reader = this.objectMapper.readerForUpdating(vstafac2);
            vstafac2 = vstafac2Reader.readValue(this.objectMapper.writeValueAsString(vstafac2Patch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", vstafac2Patch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        vstafac2 = update(vstafac2);
    ...
    public Vstafac2 delete(Vstafac2Id vstafac2Id) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Vstafac2.class.getSimpleName(), vstafac2Id);
        }
