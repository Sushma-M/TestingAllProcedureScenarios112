...
public class Vempdpt1ServiceImpl implements Vempdpt1Service {
    ...
    @Transactional(value = "SAMPLE2TransactionManager")
    @Override
    public Vempdpt1 partialUpdate(Vempdpt1Id vempdpt1Id, Map<String, Object>vempdpt1Patch) {
        LOGGER.debug("Partially Updating the Vempdpt1 with id: {}", vempdpt1Id);

        Vempdpt1 vempdpt1 = getById(vempdpt1Id);

        try {
            ObjectReader vempdpt1Reader = this.objectMapper.readerForUpdating(vempdpt1);
            vempdpt1 = vempdpt1Reader.readValue(this.objectMapper.writeValueAsString(vempdpt1Patch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", vempdpt1Patch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        vempdpt1 = update(vempdpt1);
    ...
    public Vempdpt1 delete(Vempdpt1Id vempdpt1Id) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Vempdpt1.class.getSimpleName(), vempdpt1Id);
        }
