...
public class Vprojre1ServiceImpl implements Vprojre1Service {
    ...
    @Transactional(value = "SAMPLE2TransactionManager")
    @Override
    public Vprojre1 partialUpdate(Vprojre1Id vprojre1Id, Map<String, Object>vprojre1Patch) {
        LOGGER.debug("Partially Updating the Vprojre1 with id: {}", vprojre1Id);

        Vprojre1 vprojre1 = getById(vprojre1Id);

        try {
            ObjectReader vprojre1Reader = this.objectMapper.readerForUpdating(vprojre1);
            vprojre1 = vprojre1Reader.readValue(this.objectMapper.writeValueAsString(vprojre1Patch));
        } catch (IOException ex) {
            LOGGER.debug("There was a problem in applying the patch: {}", vprojre1Patch, ex);
            throw new InvalidInputException("Could not apply patch",ex);
        }

        vprojre1 = update(vprojre1);
    ...
    public Vprojre1 delete(Vprojre1Id vprojre1Id) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(MessageResource.create("com.wavemaker.runtime.entity.not.found"), Vprojre1.class.getSimpleName(), vprojre1Id);
        }
