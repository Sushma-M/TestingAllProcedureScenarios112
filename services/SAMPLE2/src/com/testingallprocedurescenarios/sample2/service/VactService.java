...
public interface VactService {
	...
	/**
     * Find and return the list of Vacts by given id's.
     *
     ...
     *
     * @param vactIds The id's of the Vact to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Vacts associated with the given vactIds.
     */
    List<Vact> findByMultipleIds(List<VactId> vactIds, boolean orderedReturn);
     ...
     */
    Vact delete(VactId vactId);

    /**
     * Deletes an existing Vact with the given object.
     *
     * @param vact The instance of the Vact to be deleted; value cannot be null.
     */
    void delete(Vact vact);
