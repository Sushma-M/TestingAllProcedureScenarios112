...
import com.testingallprocedurescenarios.sample2.service.Vstafac1Service;
...
public class Vstafac1Controller {
    ...
    public StringWrapper exportVstafac1sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        ...
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Vstafac1.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> vstafac1Service.export(exportOptions, pageable, outputStream));
