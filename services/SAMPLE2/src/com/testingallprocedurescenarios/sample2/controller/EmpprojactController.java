...
public class EmpprojactController {
    ...
    public Empprojact patchEmpprojact(@RequestParam("empno") String empno, @RequestParam("projno") String projno, @RequestParam("actno") Short actno, @RequestParam("emptime") Float emptime, @RequestParam("emstdate") Date emstdate, @RequestParam("emendate") Date emendate, @RequestBody @MapTo(Empprojact.class) Map<String, Object> empprojactPatch) {
        ...
        empprojactId.setEmstdate(emstdate);
        empprojactId.setEmendate(emendate);
        LOGGER.debug("Partially updating Empprojact with id: {}" , empprojactId);

        Empprojact empprojact = empprojactService.partialUpdate(empprojactId, empprojactPatch);
        LOGGER.debug("Empprojact details after partial update: {}" , empprojact);
