...
import com.testingallprocedurescenarios.sample2.service.EmployeeService;
...
public class EmployeeController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee editEmployee(@PathVariable("id") String id, @RequestBody Employee employee) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee patchEmployee(@PathVariable("id") String id, @RequestBody @MapTo(Employee.class) Map<String, Object> employeePatch) {
