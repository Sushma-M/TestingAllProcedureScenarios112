...
import com.testingallprocedurescenarios.sample2.service.Vpstrde2Service;
...
public class Vpstrde2Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vpstrde2 getVpstrde2(@RequestParam("proj1no") String proj1no, @RequestParam("proj1name") String proj1name, @RequestParam("resp1no") String resp1no, @RequestParam("resp1fn") String resp1fn, @RequestParam("resp1mi") Character resp1mi, @RequestParam("resp1ln") String resp1ln, @RequestParam("proj2no") String proj2no, @RequestParam("proj2name") String proj2name, @RequestParam("resp2no") String resp2no, @RequestParam("resp2fn") String resp2fn, @RequestParam("resp2mi") Character resp2mi, @RequestParam("resp2ln") String resp2ln) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vpstrde2 editVpstrde2(@RequestParam("proj1no") String proj1no, @RequestParam("proj1name") String proj1name, @RequestParam("resp1no") String resp1no, @RequestParam("resp1fn") String resp1fn, @RequestParam("resp1mi") Character resp1mi, @RequestParam("resp1ln") String resp1ln, @RequestParam("proj2no") String proj2no, @RequestParam("proj2name") String proj2name, @RequestParam("resp2no") String resp2no, @RequestParam("resp2fn") String resp2fn, @RequestParam("resp2mi") Character resp2mi, @RequestParam("resp2ln") String resp2ln, @RequestBody Vpstrde2 vpstrde2) {
	...
	@ApiOperation(value = "Partially updates the  Vpstrde2 instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vpstrde2 patchVpstrde2(@RequestParam("proj1no") String proj1no, @RequestParam("proj1name") String proj1name, @RequestParam("resp1no") String resp1no, @RequestParam("resp1fn") String resp1fn, @RequestParam("resp1mi") Character resp1mi, @RequestParam("resp1ln") String resp1ln, @RequestParam("proj2no") String proj2no, @RequestParam("proj2name") String proj2name, @RequestParam("resp2no") String resp2no, @RequestParam("resp2fn") String resp2fn, @RequestParam("resp2mi") Character resp2mi, @RequestParam("resp2ln") String resp2ln, @RequestBody @MapTo(Vpstrde2.class) Map<String, Object> vpstrde2Patch) {
        ...
        vpstrde2Id.setResp2mi(resp2mi);
        vpstrde2Id.setResp2ln(resp2ln);
        LOGGER.debug("Partially updating Vpstrde2 with id: {}" , vpstrde2Id);

        Vpstrde2 vpstrde2 = vpstrde2Service.partialUpdate(vpstrde2Id, vpstrde2Patch);
        LOGGER.debug("Vpstrde2 details after partial update: {}" , vpstrde2);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVpstrde2(@RequestParam("proj1no") String proj1no, @RequestParam("proj1name") String proj1name, @RequestParam("resp1no") String resp1no, @RequestParam("resp1fn") String resp1fn, @RequestParam("resp1mi") Character resp1mi, @RequestParam("resp1ln") String resp1ln, @RequestParam("proj2no") String proj2no, @RequestParam("proj2name") String proj2name, @RequestParam("resp2no") String resp2no, @RequestParam("resp2fn") String resp2fn, @RequestParam("resp2mi") Character resp2mi, @RequestParam("resp2ln") String resp2ln) {
    ...
    public Page<Vpstrde2> searchVpstrde2sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Vpstrde2s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Vpstrde2> findVpstrde2s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Vpstrde2s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @XssDisable
    public StringWrapper exportVpstrde2sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Vpstrde2.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> vpstrde2Service.export(exportOptions, pageable, outputStream));
