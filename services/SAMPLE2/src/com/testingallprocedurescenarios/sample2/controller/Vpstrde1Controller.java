...
import com.testingallprocedurescenarios.sample2.service.Vpstrde1Service;
...
public class Vpstrde1Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vpstrde1 getVpstrde1(@RequestParam("proj1no") String proj1no, @RequestParam("proj1name") String proj1name, @RequestParam("resp1no") String resp1no, @RequestParam("resp1fn") String resp1fn, @RequestParam("resp1mi") Character resp1mi, @RequestParam("resp1ln") String resp1ln, @RequestParam("proj2no") String proj2no, @RequestParam("proj2name") String proj2name, @RequestParam("resp2no") String resp2no, @RequestParam("resp2fn") String resp2fn, @RequestParam("resp2mi") Character resp2mi, @RequestParam("resp2ln") String resp2ln) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vpstrde1 editVpstrde1(@RequestParam("proj1no") String proj1no, @RequestParam("proj1name") String proj1name, @RequestParam("resp1no") String resp1no, @RequestParam("resp1fn") String resp1fn, @RequestParam("resp1mi") Character resp1mi, @RequestParam("resp1ln") String resp1ln, @RequestParam("proj2no") String proj2no, @RequestParam("proj2name") String proj2name, @RequestParam("resp2no") String resp2no, @RequestParam("resp2fn") String resp2fn, @RequestParam("resp2mi") Character resp2mi, @RequestParam("resp2ln") String resp2ln, @RequestBody Vpstrde1 vpstrde1) {
    ...
    public StringWrapper exportVpstrde1sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        ...
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Vpstrde1.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> vpstrde1Service.export(exportOptions, pageable, outputStream));
