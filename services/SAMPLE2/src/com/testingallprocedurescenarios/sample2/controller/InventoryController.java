...
import com.testingallprocedurescenarios.sample2.service.InventoryService;
 ...
 * @see Inventory
 */
@RestController("SAMPLE2.InventoryController")
@Api(value = "InventoryController", description = "Exposes APIs to work with Inventory resource.")
@RequestMapping("/SAMPLE2/Inventory")
public class InventoryController {

    private static final Logger LOGGER = LoggerFactory.getLogger(InventoryController.class);

    @Autowired
	@Qualifier("SAMPLE2.InventoryService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Inventory editInventory(@PathVariable("id") String id, @RequestBody Inventory inventory) {
    ...
    @ApiOperation(value = "Partially updates the Inventory instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Inventory patchInventory(@PathVariable("id") String id, @RequestBody @MapTo(Inventory.class) Map<String, Object> inventoryPatch) {
        LOGGER.debug("Partially updating Inventory with id: {}" , id);

        Inventory inventory = inventoryService.partialUpdate(id, inventoryPatch);
        LOGGER.debug("Inventory details after partial update: {}" , inventory);
