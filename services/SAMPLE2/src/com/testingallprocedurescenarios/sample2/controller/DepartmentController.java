...
import com.testingallprocedurescenarios.sample2.service.DepartmentService;
...
public class DepartmentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Department patchDepartment(@PathVariable("id") String id, @RequestBody @MapTo(Department.class) Map<String, Object> departmentPatch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDepartment(@PathVariable("id") String id) {
