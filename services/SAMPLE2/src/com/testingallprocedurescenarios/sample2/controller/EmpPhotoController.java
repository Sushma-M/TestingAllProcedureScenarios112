...
import com.testingallprocedurescenarios.sample2.service.EmpPhotoService;
...
public class EmpPhotoController {
    ...
    public EmpPhoto createEmpPhoto(@RequestPart("wm_data_json") EmpPhoto empPhoto, @RequestPart(value = "picture", required = false) MultipartFile _picture) {
		LOGGER.debug("Create EmpPhoto with information: {}" , empPhoto);

    empPhoto.setPicture(WMMultipartUtils.toByteArray(_picture));
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmpPhoto getEmpPhoto(@RequestParam("photoFormat") String photoFormat, @RequestParam("empno") String empno) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public void getEmpPhotoBLOBContent(@RequestParam("photoFormat") String photoFormat, @RequestParam("empno") String empno, @PathVariable("fieldName") String fieldName, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmpPhoto editEmpPhoto(@RequestParam("photoFormat") String photoFormat, @RequestParam("empno") String empno, @RequestBody EmpPhoto empPhoto) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmpPhoto editEmpPhoto(@RequestParam("photoFormat") String photoFormat, @RequestParam("empno") String empno, MultipartHttpServletRequest multipartHttpServletRequest) {
        return this.editEmpPhotoAndMultiparts(photoFormat, empno, multipartHttpServletRequest);
    }

    @ApiOperation(value = "Updates the EmpPhoto instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.PUT,  consumes = "multipart/form-data")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmpPhoto editEmpPhotoAndMultiparts(@RequestParam("photoFormat") String photoFormat, @RequestParam("empno") String empno, MultipartHttpServletRequest multipartHttpServletRequest) { 

        EmpPhotoId empphotoId = new EmpPhotoId();
        empphotoId.setPhotoFormat(photoFormat);
        empphotoId.setEmpno(empno);

        EmpPhoto newEmpPhoto = WMMultipartUtils.toObject(multipartHttpServletRequest, EmpPhoto.class, "SAMPLE2");
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmpPhoto(@RequestParam("photoFormat") String photoFormat, @RequestParam("empno") String empno) {
    ...
    public StringWrapper exportEmpPhotosAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        ...
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = EmpPhoto.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> empPhotoService.export(exportOptions, pageable, outputStream));
