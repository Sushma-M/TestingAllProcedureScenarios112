...
import com.testingallprocedurescenarios.sample2.service.EmpResumeService;
...
public class EmpResumeController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmpResume getEmpResume(@RequestParam("resumeFormat") String resumeFormat, @RequestParam("empno") String empno) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmpResume editEmpResume(@RequestParam("resumeFormat") String resumeFormat, @RequestParam("empno") String empno, @RequestBody EmpResume empResume) {
	...
	@ApiOperation(value = "Partially updates the  EmpResume instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmpResume patchEmpResume(@RequestParam("resumeFormat") String resumeFormat, @RequestParam("empno") String empno, @RequestBody @MapTo(EmpResume.class) Map<String, Object> empResumePatch) {

        EmpResumeId empresumeId = new EmpResumeId();
        empresumeId.setResumeFormat(resumeFormat);
        empresumeId.setEmpno(empno);
        LOGGER.debug("Partially updating EmpResume with id: {}" , empresumeId);

        EmpResume empResume = empResumeService.partialUpdate(empresumeId, empResumePatch);
        LOGGER.debug("EmpResume details after partial update: {}" , empResume);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmpResume(@RequestParam("resumeFormat") String resumeFormat, @RequestParam("empno") String empno) {
    ...
    public Page<EmpResume> searchEmpResumesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering EmpResumes list by query filter:{}", (Object) queryFilters);
    ...
    public Page<EmpResume> findEmpResumes(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering EmpResumes list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @XssDisable
    public StringWrapper exportEmpResumesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = EmpResume.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> empResumeService.export(exportOptions, pageable, outputStream));
