...
public class PurchaseorderController {
    ...
    @ApiOperation(value = "Partially updates the Purchaseorder instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Purchaseorder patchPurchaseorder(@PathVariable("id") BigInteger id, @RequestBody @MapTo(Purchaseorder.class) Map<String, Object> purchaseorderPatch) {
        LOGGER.debug("Partially updating Purchaseorder with id: {}" , id);

        Purchaseorder purchaseorder = purchaseorderService.partialUpdate(id, purchaseorderPatch);
        LOGGER.debug("Purchaseorder details after partial update: {}" , purchaseorder);
