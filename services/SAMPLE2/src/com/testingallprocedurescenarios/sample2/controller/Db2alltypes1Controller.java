...
public class Db2alltypes1Controller {
    ...
    @ApiOperation(value = "Partially updates the Db2alltypes1 instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Db2alltypes1 patchDb2alltypes1(@PathVariable("id") Integer id, @RequestBody @MapTo(Db2alltypes1.class) Map<String, Object> db2alltypes1Patch) {
        LOGGER.debug("Partially updating Db2alltypes1 with id: {}" , id);

        Db2alltypes1 db2alltypes1 = db2alltypes1Service.partialUpdate(id, db2alltypes1Patch);
        LOGGER.debug("Db2alltypes1 details after partial update: {}" , db2alltypes1);
