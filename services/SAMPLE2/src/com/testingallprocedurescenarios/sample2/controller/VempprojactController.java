...
import com.testingallprocedurescenarios.sample2.service.VempprojactService;
...
public class VempprojactController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vempprojact getVempprojact(@RequestParam("empno") String empno, @RequestParam("projno") String projno, @RequestParam("actno") Short actno, @RequestParam("emptime") Float emptime, @RequestParam("emstdate") Date emstdate, @RequestParam("emendate") Date emendate) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vempprojact editVempprojact(@RequestParam("empno") String empno, @RequestParam("projno") String projno, @RequestParam("actno") Short actno, @RequestParam("emptime") Float emptime, @RequestParam("emstdate") Date emstdate, @RequestParam("emendate") Date emendate, @RequestBody Vempprojact vempprojact) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVempprojact(@RequestParam("empno") String empno, @RequestParam("projno") String projno, @RequestParam("actno") Short actno, @RequestParam("emptime") Float emptime, @RequestParam("emstdate") Date emstdate, @RequestParam("emendate") Date emendate) {
    ...
    public StringWrapper exportVempprojactsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        ...
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Vempprojact.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> vempprojactService.export(exportOptions, pageable, outputStream));
