...
import com.testingallprocedurescenarios.sample2.service.VempService;
...
public class VempController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vemp getVemp(@RequestParam("empno") String empno, @RequestParam("firstnme") String firstnme, @RequestParam("midinit") Character midinit, @RequestParam("lastname") String lastname, @RequestParam("workdept") String workdept) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vemp editVemp(@RequestParam("empno") String empno, @RequestParam("firstnme") String firstnme, @RequestParam("midinit") Character midinit, @RequestParam("lastname") String lastname, @RequestParam("workdept") String workdept, @RequestBody Vemp vemp) {
	...
	@ApiOperation(value = "Partially updates the  Vemp instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Vemp patchVemp(@RequestParam("empno") String empno, @RequestParam("firstnme") String firstnme, @RequestParam("midinit") Character midinit, @RequestParam("lastname") String lastname, @RequestParam("workdept") String workdept, @RequestBody @MapTo(Vemp.class) Map<String, Object> vempPatch) {
        ...
        vempId.setLastname(lastname);
        vempId.setWorkdept(workdept);
        LOGGER.debug("Partially updating Vemp with id: {}" , vempId);

        Vemp vemp = vempService.partialUpdate(vempId, vempPatch);
        LOGGER.debug("Vemp details after partial update: {}" , vemp);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVemp(@RequestParam("empno") String empno, @RequestParam("firstnme") String firstnme, @RequestParam("midinit") Character midinit, @RequestParam("lastname") String lastname, @RequestParam("workdept") String workdept) {
    ...
    public Page<Vemp> searchVempsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Vemps list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Vemp> findVemps(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Vemps list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @XssDisable
    public StringWrapper exportVempsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Vemp.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> vempService.export(exportOptions, pageable, outputStream));
