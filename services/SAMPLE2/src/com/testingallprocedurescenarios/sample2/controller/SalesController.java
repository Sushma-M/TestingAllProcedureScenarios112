...
public class SalesController {
	...
	@ApiOperation(value = "Partially updates the  Sales instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Sales patchSales(@RequestParam("salesDate") Date salesDate, @RequestParam("salesPerson") String salesPerson, @RequestParam("region") String region, @RequestParam("sales") Integer sales, @RequestBody @MapTo(Sales.class) Map<String, Object> salesInstancePatch) {
        ...
        salesId.setRegion(region);
        salesId.setSales(sales);
        LOGGER.debug("Partially updating Sales with id: {}" , salesId);

        Sales salesInstance = salesService.partialUpdate(salesId, salesInstancePatch);
