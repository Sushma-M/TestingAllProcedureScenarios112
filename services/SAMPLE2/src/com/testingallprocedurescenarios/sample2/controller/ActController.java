...
import com.testingallprocedurescenarios.sample2.service.ActService;
...
public class ActController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Act getAct(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Act editAct(@PathVariable("id") Short id, @RequestBody Act act) {
    ...
    @ApiOperation(value = "Partially updates the Act instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Act patchAct(@PathVariable("id") Short id, @RequestBody @MapTo(Act.class) Map<String, Object> actPatch) {
        LOGGER.debug("Partially updating Act with id: {}" , id);

        Act act = actService.partialUpdate(id, actPatch);
        LOGGER.debug("Act details after partial update: {}" , act);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAct(@PathVariable("id") Short id) {
    ...
    public Page<Act> searchActsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Acts list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Act> findActs(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Acts list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @XssDisable
    public StringWrapper exportActsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Act.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> actService.export(exportOptions, pageable, outputStream));
