...
import com.testingallprocedurescenarios.sample2.service.SuppliersService;
...
public class SuppliersController {
    ...
    public Suppliers createSuppliers(@RequestPart("wm_data_json") Suppliers suppliers, @RequestPart(value = "addr", required = false) MultipartFile _addr) {
		LOGGER.debug("Create Suppliers with information: {}" , suppliers);

    suppliers.setAddr(WMMultipartUtils.toByteArray(_addr));
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Suppliers getSuppliers(@PathVariable("id") String id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Suppliers editSuppliers(@PathVariable("id") String id, @RequestBody Suppliers suppliers) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Suppliers editSuppliers(@PathVariable("id") String id, MultipartHttpServletRequest multipartHttpServletRequest) {
        Suppliers newSuppliers = WMMultipartUtils.toObject(multipartHttpServletRequest, Suppliers.class, "SAMPLE2");
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteSuppliers(@PathVariable("id") String id) {
    ...
    public StringWrapper exportSuppliersAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        ...
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Suppliers.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> suppliersService.export(exportOptions, pageable, outputStream));
