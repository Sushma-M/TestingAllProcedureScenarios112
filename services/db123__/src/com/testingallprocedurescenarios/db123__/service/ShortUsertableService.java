...
public interface ShortUsertableService {
     ...
     */
    ShortUsertable getById(Short shortusertableId);
	...
	/**
     * Find and return the list of ShortUsertables by given id's.
     *
     ...
     *
     * @param shortusertableIds The id's of the ShortUsertable to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return ShortUsertables associated with the given shortusertableIds.
     */
    List<ShortUsertable> findByMultipleIds(List<Short> shortusertableIds, boolean orderedReturn);
     ...
     */
    ShortUsertable update(@Valid ShortUsertable shortUsertable);
     ...
     */
    ShortUsertable delete(Short shortusertableId);

    /**
     * Deletes an existing ShortUsertable with the given object.
     *
     * @param shortUsertable The instance of the ShortUsertable to be deleted; value cannot be null.
     */
    void delete(ShortUsertable shortUsertable);
