 ...
 */
@Service("db123__.AllExternalTypesService")
@Validated
public class AllExternalTypesServiceImpl implements AllExternalTypesService {
    ...
    @Autowired
    @Qualifier("db123__.AllExternalTypesDao")
    ...
    @Override
    public AllExternalTypes getById(AllExternalTypesId allexternaltypesId) {
    ...
    @Transactional(readOnly = true, value = "db123__TransactionManager")
    @Override
    public List<AllExternalTypes> findByMultipleIds(List<AllExternalTypesId> allexternaltypesIds, boolean orderedReturn) {
    ...
    @Transactional(value = "db123__TransactionManager")
    @Override
    public AllExternalTypes delete(AllExternalTypesId allexternaltypesId) {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service db123__ for table AllExternalTypes to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service db123__ for table AllExternalTypes to {} format", options.getExportType());
