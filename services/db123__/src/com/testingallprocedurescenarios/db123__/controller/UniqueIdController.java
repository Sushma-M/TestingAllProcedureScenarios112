...
import com.testingallprocedurescenarios.db123__.service.UniqueIdService;
...
public class UniqueIdController {
    ...
    public UniqueId createUniqueId(@RequestBody UniqueId uniqueId) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public UniqueId getUniqueId(@PathVariable("id") String id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public UniqueId editUniqueId(@PathVariable("id") String id, @RequestBody UniqueId uniqueId) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteUniqueId(@PathVariable("id") String id) {
    ...
    public Page<UniqueId> searchUniqueIdsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering UniqueIds list by query filter:{}", (Object) queryFilters);
    ...
    public Page<UniqueId> findUniqueIds(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering UniqueIds list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportUniqueIdsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = UniqueId.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> uniqueIdService.export(exportOptions, pageable, outputStream));
