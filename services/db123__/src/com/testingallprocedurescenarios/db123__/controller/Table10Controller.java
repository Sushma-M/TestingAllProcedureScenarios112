...
import com.testingallprocedurescenarios.db123__.service.Table10Service;
...
public class Table10Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table10 getTable10(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table10 editTable10(@PathVariable("id") Integer id, @RequestBody Table10 table10) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable10(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table10 getByColumn3(@PathVariable("column3") Date column3) {
        LOGGER.debug("Getting Table10 with uniques key Column3");
        return table10Service.getByColumn3(column3);
    }
    ...
    public Page<Table10> searchTable10sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Table10s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Table10> findTable10s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Table10s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportTable10sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Table10.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> table10Service.export(exportOptions, pageable, outputStream));
