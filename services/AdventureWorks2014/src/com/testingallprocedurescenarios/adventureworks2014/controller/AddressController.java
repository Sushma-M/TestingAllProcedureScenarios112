...
import com.testingallprocedurescenarios.adventureworks2014.service.AddressService;
...
public class AddressController {
    ...
    public Address createAddress(@RequestPart("wm_data_json") Address address, @RequestPart(value = "spatialLocation", required = false) MultipartFile _spatialLocation) {
		LOGGER.debug("Create Address with information: {}" , address);

    address.setSpatialLocation(WMMultipartUtils.toByteArray(_spatialLocation));
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Address editAddress(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
